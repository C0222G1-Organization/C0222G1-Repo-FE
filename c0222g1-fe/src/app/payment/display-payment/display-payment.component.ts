    ...
    render(
      {
        ...
        onApprove: (details) => {
          if (details.status === 'COMPLETED') {
            this.paymentService.sendJson(details);
            setInterval(() => {
          ...
          // const bs64 = 'sb-vcg7w19738995@personal.example.com:-wfy6J+.';
          // const encode = Buffer.from(bs64).toString('base64');
          // console.log(encode);
          // xmlHttpRequest.open('GET', details.links[0].href, true, 'sb-vcg7w19738995@personal.example.com', '-wfy6J+.');
          // xmlHttpRequest.setRequestHeader('Authorization', 'Basic ' + encode);
